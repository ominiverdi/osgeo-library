...
Usage:
    from doclibrary.search.embeddings import get_embedding, get_embeddings
...
def get_embeddings(texts: List[str], normalize: bool = True) -> Optional[List[List[float]]]:
    """
...
if __name__ == "__main__":
    ...
    if not check_server():
        print(f"ERROR: Embedding server not running at {config.embed_health_url}")
        sys.exit(1)
